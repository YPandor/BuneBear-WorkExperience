...
function log_action($action, $message="") {
  ...
  */
  ...
  // $logInMessage = "Login: ".$username." logged in.";
  // $logOutMessage = "Logged out: ".$username." logged out.";
  // $logsClearedMessage = "Logs cleared: by User ID ".$id;

  $logMessage = $action." | ".$message.PHP_EOL;

  
  $myLog = fopen("../../logs/log.txt", "a");
  fwrite($myLog, $logMessage);
  fclose($myLog);
